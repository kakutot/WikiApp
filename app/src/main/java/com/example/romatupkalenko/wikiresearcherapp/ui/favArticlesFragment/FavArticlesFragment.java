...
public class FavArticlesFragment extends Fragment implements MyAdapter.MyAdapterOnItemClickHandler {
    ...
    private void initMainViewModel(){
        MainViewModelFactory factory = InjectorUtils.provideMainActivityViewModelFactory(getContext());
        ...
        mViewModel.getFavArticles() .observe(this, newArticles ->
        {
    ...
    private void initRecyclerView(){
        ...
        mAdapter = new MyAdapter(getContext(),this);
